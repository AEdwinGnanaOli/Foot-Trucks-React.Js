...
function AdminProductUpdate() {
    ...
    useEffect(() => {
        axios.get('https://foot-trucks-react-js.onrender.com/getproductdetails/' + id).then(user => {
            setUserData({
    ...
    const onSubmit = async (e) => {
        try {
            ...
            axios.put('https://foot-trucks-react-js.onrender.com/productupdate/' + id, formData).then((user) => {
                console.log(user)
    ...
    return (
        <Dashboard title={'Product-Update'}>
        <Container>
            <Row className="" >
                <Form className="signin-from" style={{ width: '25rem' }} onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <Col>
                        <Form.Group className="mb-3">
                            <Form.Label>Choose Shop Image</Form.Label>
                            <Form.Control type="file" placeholder="Enter The Phone Number"
                                onChange={e => setUserData({ ...userData, shop: e.target.files[0] })} />
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group className="mb-3">
                            <Form.Label>Choose Menu Image</Form.Label>
                            <Form.Control type="file" placeholder="Enter The Phone Number"
                                onChange={e => setUserData({ ...userData, menu: e.target.files[0] })} />
