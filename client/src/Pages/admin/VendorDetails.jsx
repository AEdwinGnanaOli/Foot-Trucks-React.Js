...
function VendorDetails() {
  ...
  useEffect(() => {
    axios.get('https://foot-trucks-react-js.onrender.com/admin/vendordetails').then((result) => {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://foot-trucks-react-js.onrender.com/vendor/delete/${id}`).then((user) => {
