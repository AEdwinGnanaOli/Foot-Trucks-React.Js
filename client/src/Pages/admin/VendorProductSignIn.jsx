...
function ProductSignIn() {
  ...
  return (
    <Dashboard title={'Product-SignIn'}>
      <Container>
        <Row className="">
          <Col className='form-header'>
            <Form
              className="signin-form-product"
              style={{ width: "25rem" }}
            ...
            >
              ...
              <Col>
                <Form.Group className="mb-3">
                  <Form.Label>Choose ShopImage</Form.Label>
                  <Form.Control
                    type="file"
                    placeholder="Enter The Phone Number"
                    onChange={(e) =>
                      setUserData({ ...userData, shop: e.target.files[0] })
                    }
                  />
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-3">
                  <Form.Label>Choose MenuImage</Form.Label>
                  <Form.Control
                    type="file"
                    placeholder="Enter The Phone Number"
                    onChange={(e) =>
                      setUserData({ ...userData, menu: e.target.files[0] })
                    }
                  />
                </Form.Group>
              </Col>
