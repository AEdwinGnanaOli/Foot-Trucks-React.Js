...
function AdminVendorUpdate() {
  ...
  useEffect(() => {
    axios.get('https://foot-trucks-react-js.onrender.com/getuser/vendor/details/' + id).then(user => {
      setUserData(
        {
  ...
  const onSubmit = async (e) => {
    try {
      ...
      axios.put('https://foot-trucks-react-js.onrender.com/vendor/update/'+id, { ...userData }).then((user) => {
