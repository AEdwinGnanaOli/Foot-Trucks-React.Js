const { SignUp, VendorSignUp, Login, Forgot, Reset, ProductRegister, ProductFullDetails, ProductUpdate, ProductDelete, vendorUpdate, userUpdate, getProductsDetails, getUserAndVendorDtails, Products, } = require('../Controllers/AuthuController');
...
const { Likes,LikeProduct } = require('../Controllers/likes');
...
router.post("/productregister/:vendorId", upload.fields([{name:'file1'},{name:'file2'}]), ProductRegister);
...
router.put('/productupdate/:id', upload.fields([{name:'file1'},{name:'file2'}]), ProductUpdate);
...
router.get('/user-likes/:userId',LikeProduct)
