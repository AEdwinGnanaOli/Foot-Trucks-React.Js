...
module.exports.UserCart = async (req, res, next) => {
    try {
        ...
        const userCart = await UserCart.create({ userId: userId, ProductId:vendorId, shopname: product.shopname, shopaddress: product.shopaddress, shopmobilenumber: product.shopmobilenumber, shopImage: product.shopImage,menuImage:product.menuImage,role:'UserCart' })
